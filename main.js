...
// const pricePercentageChange = process.argv[5]; // 0 to 100, default is 1.4
...
// const trader = new DailyTrader(traderName, strategy, pair, pricePercentageChange, cryptoTradingAmount);
